...
function AdminDashboard({ demo, onSignOut }: { demo: boolean; onSignOut: () => void }) {
  ...
  const readyMatchCount = snapshot.matches.filter((match) => match.status === "ready").length;
